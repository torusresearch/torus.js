  ...
  it("should still login v1 account correctly", async function () {
    ...
    expect(retrieveSharesResponse).eql({
      finalKeyData: {
        ...
        X: "28791725684617741539794713367138009203742373976762713376477976695969223421073",
        Y: "31963659117858991836451415875221007566688067606268800158620363382690552926420",
  ...
  it("should still aggregate account v1 user correctly", async function () {
    ...
    expect(retrieveSharesResponse).eql({
      finalKeyData: {
        ...
        X: "54456953762754495648745105516045030283478616462159514856919303547649756337955",
        Y: "20962321879729253335080221216649438668436420171192718569043641743378689094907",
  ...
  it("should still login v2 account correctly", async function () {
    ...
    expect(retrieveSharesResponse).eql({
      finalKeyData: {
        ...
        X: "78384639273521458089047405072137536963800483460438205915578317497287406022228",
        Y: "57974546825806475821443120888451716098460024516231724925952591729816755206881",
