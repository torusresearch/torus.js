...
fetchNodeDetails.getNodeDetails().then((nodeInfo) => {
    torus.getPublicAddress(nodeInfo.torusNodeEndpoints, nodeInfo.torusNodePub, { verifier: "google", verifierId: "zhen@tor.us" }).then( (response) => {
